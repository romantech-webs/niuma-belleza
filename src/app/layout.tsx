  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="niuma-belleza";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="NIUMA BELLEZA"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="niuma-belleza"
          data-primary-color="#ba8b5b"
          defer
        ></script>
      </head>
